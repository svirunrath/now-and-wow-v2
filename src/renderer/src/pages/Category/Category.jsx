...
import { Form, Input, InputNumber, Popconfirm, Typography, Button, Select } from 'antd'
import './Category.css'
...
const Category = () => {
      ...
      render: (_, record) => {
        ...
        return editable ? (
          <span>
            ...
            <Popconfirm title="Are you sure you want to cancel?" onConfirm={handleMainCancel}>
              <a>Cancel</a>
            </Popconfirm>
          </span>
        ) : (
          <span>
            <Typography.Link disabled={editingKey !== ''} onClick={() => handleMainEdit(record)}>
              Edit
            </Typography.Link>
            <Popconfirm
            ...
            >
              <Typography.Link disabled={editingKey !== ''} style={{ marginLeft: 10 }}>
                Delete
              </Typography.Link>
            </Popconfirm>
          </span>
  ...
  if (!isLoading) {
    for (let i = 0; i < data.main_category.length; i++) {
      ...
      mainChildren.push(
        <Option key={data.main_category[i].category_id} value={data.main_category[i].category_id}>
        ...
        render: (_, record) => {
          ...
          return editable ? (
            <span>
              ...
              <Popconfirm title="Are you sure you want to cancel?" onConfirm={handleSubCancel}>
                <a>Cancel</a>
              </Popconfirm>
            </span>
          ) : (
  ...
  return (
    <>
      <div className="category-main-container">
        <header className="categpry-main-header">
          ...
          <div className="category-body">
            <div className="category-main-block">
              ...
              <div className="main-category-input">
                ...
                <Input value={catName} onChange={(e) => setCatName(e.target.value)}></Input>
              </div>
            ...
            <div className="category-main-block">
              ...
              <div className="main-category-input">
                ...
                <Input onChange={(e) => setSubName(e.target.value)} value={subName}></Input>
              </div>
              <div className="button-wrapper">
                <Button
                  type="primary"
